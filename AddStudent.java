...
public class AddStudent extends JFrame implements ActionListener{
    ...
    JTextField stuname,stufname,roll,add,phone,mail,x,xii,ug;
    JDateChooser dcdob;
    ...
    AddStudent(){
        ...
        stuname.setBounds(130, 150, 150, 20);
        add(stuname);
        ...
        lblcourse.setBounds(50, 400, 100, 20);
        ...
        cbbox.setBounds(130, 400, 150, 20);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/addstudent.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource()== submit){
            ...
            try{
                String query = "insert into student values('"+name+"','"+fname+"','"+rollno+"','"+address+"','"+phoneno+"','"+email+"','"+ugmarks+"','"+xiimarks+"','"+xmarks+"','"+dob+"','"+course+"','"+branch+"')";
